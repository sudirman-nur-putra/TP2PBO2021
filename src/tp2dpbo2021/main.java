...
public class main extends javax.swing.JFrame {
    ...
    public void getData( ){
     ...
     try{
           //membuat statemen pemanggilan data pada table data mobil dari database
           Statement stat = (Statement) koneksi.getKoneksi().createStatement();
           String sql        = "Select * from dpbo2";
           ...
           while(res.next ()){
                ...
                obj[0] = res.getString("warna");
                obj[0] = res.getString("jenis");
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("NewsGoth BT", 0, 36)); // NOI18N
